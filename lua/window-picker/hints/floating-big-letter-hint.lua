...
function M:draw(windows, or_create, autoselect_one)
	local dont_draw_center_hint = autoselect_one and or_create and #windows == 1
	for index, window in ipairs(windows) do
		if not dont_draw_center_hint then
